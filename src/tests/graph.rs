...
async fn should_parse_connections_and_node_data() {
    ...
    assert_eq!(
        ...
        Node {
            ...
            parent_id: Some("5d93b936-5952-4707-89dd-69ca06c60850".uuid()),
            children: Vec::new(),
            metadata: None,
            body: None,
            connections: map! {
    ...
    assert_eq!(
        ...
        Node {
            ...
            parent_id: Some("5d93b936-5952-4707-89dd-69ca06c60851".uuid()),
            children: Vec::new(),
            metadata: None,
            body: None,
            connections: map! {
    ...
    assert_eq!(
        ...
        Node {
            ...
            parent_tags: ["hello", "world", "parent_tag"].into_hs(),
            parent_id: Some("5d93b936-5952-4707-89dd-69ca06c60852".uuid()),
            children: Vec::new(),
            metadata: None,
            body: None,
            connections: map! {
    ...
    assert_eq!(
        ...
        vec![
            Node {
                ...
                tags: ["hello"].into_hs(),
                parent_tags: [].into(),
                parent_id: Some("7097edb8-7a66-45fe-aec3-eb957f511ab0".uuid()),
                children: Vec::new(),
                metadata: None,
                body: None,
                connections: map! {},
